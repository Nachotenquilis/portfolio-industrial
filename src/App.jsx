  ...
  return (
    <div className="min-h-screen grid-bg relative selection:bg-enagas-cyan selection:text-white transition-colors duration-700">
      ...
      <div className="max-w-7xl mx-auto min-h-screen lg:flex relative z-10">
        ...
        <header className="lg:sticky lg:top-0 lg:max-h-screen lg:w-5/12 lg:flex lg:flex-col py-6 lg:py-6 px-6 lg:pl-12 xl:pl-20 overflow-y-auto scrollbar-thin scrollbar-thumb-slate-300 dark:scrollbar-thumb-slate-700">
          <Sidebar />
        </header>
